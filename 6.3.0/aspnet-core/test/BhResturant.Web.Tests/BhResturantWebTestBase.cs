...
{
    public abstract class BhResturantWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BhResturantWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BhResturantWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BhResturantDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BhResturantDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BhResturantDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BhResturantDbContext, Task<T>> func)
        {
            T result;
